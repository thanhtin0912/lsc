			...
			<div class="portlet-body form">
				...
				<form id="frmManagement" action="<?=PATH_URL_ADMIN.$module.'/save/'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-2">Danh mục cha: <span class="required" aria-required="true">*</span></label>
							<div class="col-md-6">
								<select class="select form-control" data-live-search="true" data-size="8" name="cateAdmincp" id="cateAdmincp">
									<option value="">None</option>
									<?php foreach ($cata as $key => $cate): ?>
										<?php  
											$select = '';
										...
										?>
										<option value="<?= $cate->id; ?>" <?= $select; ?> ><?= $cate->name_vn; ?> - <?= $cate->name_en; ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-md-2">Hình đại diện(500x500): <span class="required" aria-required="true">*</span></label>
							<div class="col-md-3">
								<div class="fileinput fileinput-new" data-provides="fileinput">
									<?php if(isset($result->avata)){ if($result->avata!=''){ ?>
									<div class="fileinput-new thumbnail" style="width: 150px; height: 150px;">
										<img src="<?=resizeImage(PATH_URL.DIR_UPLOAD_CATA.$result->avata,150, 150)?>" />
									</div>
									<?php }} ?>
