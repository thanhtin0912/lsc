				...
				<form id="frmManagement" action="<?=PATH_URL_ADMIN.$module.'/save/'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<label class="control-label col-md-2">Kho tổng: <span class="required" aria-required="true">*</span></label>
							<div class="col-md-3">
								<label class="radio-inline"><input type="radio" name="isMainAdmincp" value="0" <?= isset($result->isMain) ? $result->isMain == 0 ? 'checked' : '' : '' ?> > Không</label>
								<label class="radio-inline"><input type="radio" name="isMainAdmincp" value="1" <?= isset($result->isMain) ? $result->isMain == 1 ? 'checked' : '' : 'checked' ?> > Có</label>
							</div>
