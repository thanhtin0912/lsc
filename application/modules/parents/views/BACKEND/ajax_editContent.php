...
function showRequest(formData, jqForm, options) {
	...
	if(form.name_vnAdmincp.value == ''  || form.name_enAdmincp.value == '' ){
			...
			<div class="portlet-body form">
				...
				<form id="frmManagement" action="<?=PATH_URL_ADMIN.$module.'/save/'?>" method="post" enctype="multipart/form-data" class="form-horizontal form-row-seperated">
					...
					<div class="form-body">
						...
						<div class="form-group">
							<label class="control-label col-md-2">Name VN: <span class="required" aria-required="true">*</span></label>
						...
						<div class="form-group">
							<label class="control-label col-md-2">Name EN: <span class="required" aria-required="true">*</span></label>
