		...
		<table class="table table-striped table-bordered table-hover dataTable no-footer">
			<thead>
				<tr role="row">
					...
					<th class="sorting" onclick="sort('name')" id="title">Name</th>
					<th class="sorting" onclick="sort('phone')" id="title">Số điện thoại</th>
					<th class="sorting" onclick="sort('mail')" id="title">Email</th>
